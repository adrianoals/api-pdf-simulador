...
exports.validatePDFRequest = validatePDFRequest;
exports.sanitizePDFRequest = sanitizePDFRequest;
exports.validateRequestLimits = validateRequestLimits;
 ...
 */
function validatePDFRequest(request) {
    const errors = [];
    // Validar IDs
 ...
 */
function sanitizePDFRequest(request) {
    return {
 ...
 */
function validateRequestLimits(request) {
    const errors = [];
